...
#ifndef LOG_NO_TODO
#define LOG_TODO(msg) lib::logging::log("[todo]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
#ifndef LOG_NO_INFO
#define LOG_INFO(msg) lib::logging::log("[info]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
#define LOG_WARNING(msg) lib::logging::log("[warn]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
#ifndef LOG_NO_ERROR
#define LOG_ERROR(msg) lib::logging::log("[err]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
#ifndef LOG_NO_FATAL
#define LOG_FATAL(msg) lib::logging::log("[fatal]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
#define LOG_DEPRECATED(msg) lib::logging::log("[dep]", msg, LOGGING_FILE_NAME, LOGGING_FUNC_STR, __LINE__);
...
namespace
{
  uint32_t logging_outputs = lib::logging::out::console;
...
set_output(const uint32_t output)
{
  ...
  if(logging_outputs & lib::logging::out::file)
  {
...
log(const char *prefix,
    ...
    const uint32_t line)
{
  if(logging_outputs & lib::logging::out::console)
  {
    printf("\n-\n");
