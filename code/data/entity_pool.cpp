...
Entity_pool::Entity_pool(const std::size_t number_of_entities)
{
...
std::size_t
Entity_pool::find_index(const Entity::Entity_id id) const
{
...
std::size_t
Entity_pool::add_entity(const Entity::Entity_id id)
{
  if(size() < capacity())
  {
...
bool
Entity_pool::erase_entity(const Entity::Entity_id id)
{
