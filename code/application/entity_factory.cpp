...
create_ground(Data::Entity_pool *entity, const Data::Model_pool *mesh_resources, const Data::Texture_pool *texture_resources)
{
  ...
  if(Entity::find_index_linearly(&empty_index, Entity::invalid_id(), entity->entity_id, entity->size))
  {
    ...
    // Setup phys
    {
      entity->rigidbody_property[empty_index].collider_type = Physics::Collider_type::static_plane;
      entity->rigidbody_property[empty_index].collider_info.static_plane.normal[0] = 0;
      entity->rigidbody_property[empty_index].collider_info.static_plane.normal[1] = 1;
      entity->rigidbody_property[empty_index].collider_info.static_plane.normal[2] = 0;
...
create_actor(Data::Entity_pool *entity, const Data::Model_pool *mesh_resources, const Data::Texture_pool *texture_resources)
{
  ...
  if(Entity::find_index_linearly(&empty_index, Entity::invalid_id(), entity->entity_id, entity->size))
  {
    ...
    // Setup phys
    {
      ...
      entity->rigidbody_property[empty_index].collider_type                = Physics::Collider_type::capsule;
      entity->rigidbody_property[empty_index].collider_info.capsule.radius = scale_x * 0.5;
      entity->rigidbody_property[empty_index].collider_info.capsule.height = scale_x * 1;
...
create_kinematic_actor(Data::Entity_pool *entity, const Data::Model_pool *mesh_resources, const Data::Texture_pool *texture_resources)
{
  ...
  if(Entity::find_index_linearly(&empty_index, Entity::invalid_id(), entity->entity_id, entity->size))
  {
    ...
    entity->rigidbody_property[empty_index].collider_type = Physics::Collider_type::none;
