...
//    
//    math::aabb aabb;
//    Data::Graph::aabb_get(entity, this_id, &aabb);
//    
//    entity_scale = math::vec3_multiply(
//      transform.scale,
...
//    Bullet_data::Rigidbody rigidbody;
//    Data::rigidbody_get_rigidbody(rb_data, this_id, &rigidbody);
//    Physics_transform::create_core_rb_from_rigidbody(
//      &core_rb,
//      entity_scale,
//      &rigidbody
//    );
...
//  LIB_ASSERT(entity_data);
//  LIB_ASSERT(rb_data);
//  LIB_ASSERT(trigger_data);
//  LIB_ASSERT(phy_world);
//  
